...
[![Logo](https://files.catbox.moe/c5s9g0.jpg)](https://www.npmjs.com/package/@felicesama/baileys)
...
<p align="center">
   ...
   <br><br>
   <a href="https://www.npmjs.com/package/@felicesama/baileys">
      <img src="https://img.shields.io/npm/v/@felicesama/baileys?style=for-the-badge&logo=npm"/>
   </a>
   <a href="https://www.npmjs.com/package/@felicesama/baileys">
      <img src="https://img.shields.io/npm/dm/@felicesama/baileys?style=for-the-badge&logo=npm"/>
   </a>
   <a href="https://github.com/felicesama/baileys">
      <img src="https://img.shields.io/github/stars/felicesama/baileys?style=for-the-badge&logo=github"/>
   </a>
   <a href="LICENSE">
...
# NPM
"dependencies": {
   "@felicesama/baileys": "latest"
}

# GitHub
"dependencies": {
   "@felicesama/baileys": "github:felicesama/baileys"
}
```
...
```bash
# NPM
npm i @felicesama/baileys@latest

# GitHub
npm i github:felicesama/baileys
```
...
```javascript
// --- ESM
import { makeWASocket } from '@felicesama/baileys'

// --- CJS (tested and working on Node.js 24 ✅)
const { makeWASocket } = require('@felicesama/baileys')
```

### 🌐 Connect to WhatsApp (Quick Step)

```javascript
import { makeWASocket, delay, DisconnectReason, useMultiFileAuthState } from '@felicesama/baileys'
...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from '@felicesama/baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
const urlA = 'https://www.npmjs.com/package/@felicesama/baileys'

sock.sendMessage(jid, {
   text: urlA + ' 👆🏻 Check it out!',
   linkPreview: {
      'matched-text': urlA,
      title: '🌱 @felicesama/baileys',
...
import { prepareWAMessageMedia } from '@felicesama/baileys'

const urlB = 'https://www.npmjs.com/package/@felicesama/baileys#readme'
...
const groupName = '@felicesama/baileys'
...
sock.sendMessage(jid, {
   ...
   product: {
      ...
      signedUrl: 'https://www.npmjs.com/package/@felicesama/baileys',
      title: '📦 Starseed (Premium)',
      url: 'https://www.npmjs.com/package/@felicesama/baileys'
   },
...
```javascript
import { tokenizeCode } from '@felicesama/baileys'
...
sock.sendMessage(jid, {
   ...
   publisher: '🌟 Lia Wynn',
   description: '@felicesama/baileys'
}, {
   quoted: message
})
```
...
sock.sendMessage(jid, {
   ...
   offerCode: '@felicesama/baileys', // --- Optional
   offerUrl: 'https://www.npmjs.com/package/@felicesama/baileys', // --- Optional
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      offerCode: '@felicesama/baileys',
      offerUrl: 'https://www.npmjs.com/package/@felicesama/baileys',
...
sock.sendMessage(jid, {
   ...
   externalAdReply: {
      ...
      url: 'https://www.npmjs.com/package/@felicesama/baileys' // --- Optional, used for WhatsApp internal thumbnail caching and direct URL
   }
}, {
   quoted: message
})
...
```javascript
import { getImageProcessingLibrary } from '@felicesama/baileys'
...
```javascript
// --- Create a new one
sock.newsletterCreate('@felicesama/baileys', '📣 Fresh updates weekly')
...
// --- Update newsletter
sock.newsletterUpdate('1231111111111@newsletter', { name: '@felicesama/baileys' })

// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 @felicesama/baileys')
...
const group = sock.groupCreate('@felicesama/baileys', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 @felicesama/baileys')
...
sock.updateMemberLabel(jid, '@felicesama/baileys')
```
...
const community = await sock.communityCreate('@felicesama/baileys', '📣 Fresh updates weekly')
...
// --- Change name
sock.communityUpdateSubject(jid, '📦 @felicesama/baileys')
...
await sock.updateBusinessProfile({
   ...
   websites: ['https://www.npmjs.com/package/@felicesama/baileys'],
...
A fast, lightweight, and modular WhatsApp bot built with [@felicesama/baileys](https://www.npmjs.com/package/@felicesama/baileys).
Perfect for managing groups, moderating chats, and adding fun with quiz games and handy tools.

👉🏻 [@felicesama/starseed](https://github.com/felicesama/starseed#readme)
...
This fork includes additional enhancements and modifications by [Lia Wynn](https://github.com/felicesama)
